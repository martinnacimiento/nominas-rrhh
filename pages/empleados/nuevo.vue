...
export default {
  ...
  data: () => ({
    ...
    item: { fecha_nacimiento: null, fecha_ingreso: null, foto_perfil: 'dog' },
    loading: false,
    menu1: false,
    menu2: false,
  }),
  methods: {
    async save() {
      if (this.$refs.form.validate()) {
        this.loading = true
        try {
          await this.$axios.$post(`empleados`, this.item)
          this.snack('Empleado creado con exito.')
